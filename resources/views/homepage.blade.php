{{-- @include('header'); --}} 
{{-- Option 1 is to include the header.blade.php file  --}}
{{-- Option 2 is to create a component > layout.blade.php and folder and file --}}
{{-- The layout has the literal code for the header and footer with {{$slot}} in the middle --}}
{{-- The code that goes in the slot varies from page to page and is placed
    in the slot using the "x-layout opening and closing tags" --}}
    ...
    <div class="container py-md-5">
        <div class="row align-items-center">
          ...
          <div class="col-lg-5 pl-lg-5 pb-3 py-lg-5">
            {{-- action value is the url that the form --}}
            <form action="/register" method="POST" id="registration-form">
              ...
              <div class="form-group">
                ...
                <input value="{{old('username')}}"name="email" id="email-register" class="form-control" type="text" placeholder="you@example.com" autocomplete="off" />
                @error('email')
                <p class="m-0 small alert alert-danger shadow-sm">{{$message}}</p>
                @enderror
              </div>
